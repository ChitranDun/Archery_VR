...
public class BowStringController : MonoBehaviour
{
    ...
    [SerializeField]
    private Transform midPointGrabObject, midPointVisualObject, midPointPerent;
    ...
    private void Update()
    {
        if (interactor != null)
        {
            ...
            Vector3 midPointLocalSpace = midPointPerent.InverseTransformPoint(midPointGrabObject.position);
